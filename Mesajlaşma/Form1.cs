...
namespace Mesajlaşma
{
    public partial class Form1 : Form
    {
        ...
        private static bool formAcik = false;
        ...
        private void Gönderbutton_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                Messages messages = new Messages { Mesajlar = "server:" + MesajYazmatextBox.Text, Tarih = Time };
        ...
        private void MesajYazmatextBox_TextChanged(object sender, EventArgs e)
        {
        }
    }
}
